        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrevisaoDevolucao = table.Column<DateOnly>(type: "date", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    MultaTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CodigoDeBarras = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemEmprestimo_Emprestimo_EmprestimoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataMulta = table.Column<DateOnly>(type: "date", nullable: false),
                    EmprestimoId = table.Column<int>(type: "int", nullable: false),
                    ItemEmprestimoId = table.Column<int>(type: "int", nullable: false),
                    EmprestimoId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemEmprestimo_ExemplarId",
                table: "ItemEmprestimo",
                column: "ExemplarId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemVenda_ExemplarId",
                table: "ItemVenda",
                column: "ExemplarId");
